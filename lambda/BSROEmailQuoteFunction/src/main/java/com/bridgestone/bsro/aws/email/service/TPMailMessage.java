...
import com.bridgestone.bsro.aws.email.model.tire.States;
import com.bridgestone.bsro.aws.email.model.tire.Store;

public class TPMailMessage extends MailMessage {
	...
	public static final String TP_LOCAL_PAGE_URL =  "http://local.tiresplus.com";
	public static final String HTP_LOCAL_PAGE_URL =  "http://local.hibdontire.com";
	public static final String WWT_LOCAL_PAGE_URL =  "http://local.wheelworks.net";
	...
	public String getBannerHTML() {
		...
		mailMessage.append("<img src=\"%%BASE_URL%%/content/dam/bsro/global/images/email/header-tp.jpg\" width=\"675\" height=\"150\" border=\"0\" alt=\"Tires Plus Total Car Care - The Plus is in Everything We Do.\" />\n");
	...
	public String getQuoteFooterHTML() {
		...
		mailMessage.append("<br /><br />\n");
		mailMessage.append("&copy;%%COPY_RIGHT_YEAR%% Tires Plus Total Car Care | <a href=\"%%BASE_URL%%/privacy-policy/\" style=\"color:#C00;\" target=\"_blank\">Privacy Statement</a> | <a href=\"%%BASE_URL%%/legal-notice/\" style=\"color:#C00;\" target=\"_blank\">Legal Notice</a> | <a href=\"%%BASE_URL%%/email-signup/unsubscribe/\" style=\"color:#C00;\" target=\"_blank\">Unsubscribe</a><br />\n");
	...
	public String getCfnaHtml() {
		StringBuilder mailMessage = new StringBuilder();
		mailMessage.append("<a href=\"https://www.cfna.com/web/personalservices/tiresplus\" target=\"_blank\" id=\"cfna1\">\n");
		mailMessage.append("<img src=\"%%BASE_URL%%/content/dam/bsro/global/images/email/email-quote-tp.png\" width=\"220\" height=\"54\" alt=\"Convenient Credit. Quick online applications.\" border=\"0\" />\n");
		mailMessage.append("</a>\n");
		return mailMessage.toString();
	}
	...
	public String getTireQuoteURL() {
		return "%%BASE_URL%%/content/bsro/tiresplus/en/tires/tire-quote.html?quoteId=%%QUOTE_ID%%&lw_cmp=int-em_tp_eg-tp-tires-other_em-link";
	}
