...
public class WWTMailMessage extends MailMessage {
	...
	public String getBannerHTML() {
		...
		mailMessage.append("<img src=\"%%BASE_URL%%/content/dam/bsro/global/images/email/header-wwt.jpg\" width=\"675\" height=\"150\" border=\"0\" alt=\"Wheel Works.\" />\n");
	...
	public String getQuoteFooterHTML() {
		...
		mailMessage.append("<br /><br />\n");
		mailMessage.append("&copy;%%COPY_RIGHT_YEAR%% Tires Plus Total Car Care | <a href=\"%%BASE_URL%%/privacy/\" style=\"color:#C00;\" target=\"_blank\">Privacy Statement</a> | <a href=\"%%BASE_URL%%/legal/\" style=\"color:#C00;\" target=\"_blank\">Legal Notice</a> | <a href=\"%%BASE_URL%%/email-signup/unsubscribe/\" style=\"color:#C00;\" target=\"_blank\">Unsubscribe</a><br />\n");
	...
	public String getCfnaHtml() {
		StringBuilder mailMessage = new StringBuilder();
		mailMessage.append("<a href=\"https://www.cfna.com/web/personalservices/wheelworks\" target=\"_blank\" id=\"cfna1\">\n");
		mailMessage.append("<img src=\"%%BASE_URL%%/content/dam/bsro/global/images/email/email-quote-wwt.png\" width=\"220\" height=\"54\" alt=\"Convenient Credit. Quick online applications.\" border=\"0\" />\n");
		mailMessage.append("</a>\n");
		return mailMessage.toString();
	}
	...
	public String getTireQuoteURL() {
		return "%%BASE_URL%%/content/bsro/wheelworks/en/tires/tire-quote.html?quoteId=%%QUOTE_ID%%&lw_cmp=int-em_ww_eg-ww-tires-other_em-link";
	}
