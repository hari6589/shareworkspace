...
//			}
	...
	public static void main(String[] args) {
		...
		try {
			...
			//System.out.println("Quote Data : " + tireQuote.toString());
			if(source.equals("tire")) {
				TireQuote tireQuote = quote.getTireQuote("50");
				messageContent = generateTireQuoteMessage(tireQuote, store, siteName, firstName, lastName, email);
			} else if(source.equals("battery")) {
				//TireQuote tireQuote = quote.getTireQuote("50");
				//messageContent = generateBatteryQuoteMessage(tireQuote, store, siteName, firstName, lastName, email);
			} else if(source.equals("alignment")) {
				//TireQuote tireQuote = quote.getTireQuote("50");
				//messageContent = generateAlignmentQuoteMessage(tireQuote, store, siteName, firstName, lastName, email);
			}
	...
	public static String generateTireQuoteMessage(TireQuote tireQuote, Store store, String siteName, String firstName, String lastName, String email) throws UnsupportedEncodingException {
		...
		String messageTemplate = new MailMessageTemplate().getTireQuoteMailMessage();
		...
		String appointmentURL = baseURL
				...
				+ "2745" //if(MVAN) 2782 else 2745 // maintenanceChoice
