...
/**
 * Mileage generated by hbm2java
 */
@JsonSerialize(include = JsonSerialize.Inclusion.NON_DEFAULT)
public class Mileage implements java.io.Serializable {
	...
	/** minimal constructor */
	public Mileage(long id, String value) {
		this.id = id;
		this.value = value;
	}

	/** full constructor */
	public Mileage(long id, String value, Set configurations) {
		this.id = id;
		this.value = value;
